...
if (NOT BLAS_FOUND)
  ...
  # 1: only SEQ third_party are handled
  # 2: both SEQ and PAR third_party are handled
  find_package_blas()
endif ()

# detect the cases where SEQ and PAR third_party are handled
...
elseif(BLA_VENDOR MATCHES "IBMESSL*")
  ...
  if(BLAS_FOUND)
    # define the SEQ third_party as the BLAS_LIBRARIES
    set(BLAS_SEQ_LIBRARIES "${BLAS_LIBRARIES}")
  else()
    set(BLAS_SEQ_LIBRARIES "${BLAS_SEQ_LIBRARIES-NOTFOUND}")
  endif()
